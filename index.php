    ...
    <div class="fixed-top">
        ...
        <header>
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-dark">
                    <a class="navbar-brand" href="#home">Being Human</a>
        ...
        <div class="cont-sec">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        <p>Contact No : <a href="tel: +91 9881670392">+91 9881670392</a></p>
                    </div>
                    <div class="col-lg-6">
                        <div class="social">
                ...
                <div class="row">
                    <div class="col-lg-6 align-item-center">
                        <div class="home-info">
                            ...
                            <h2>We <span>Being Human</span> manage wastage for needy peoples</h2>
                            <p>There is nothing greater than love invested in helping to feed the impoverished living in hunger.
</p>
                            <div class="buttons">
                                <a href="#contact" class="btn1">Donate Here</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="don-box">
                        ...
                        <h3>Clothes</h3>
                        <p>Donate the Clothes to the needy</p>
                        <a href="#contact" class="btn1">Donate Here</a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="don-box">
                        ...
                        <h3>Footware</h3>
                        <p>Donate the Footware to the needy</p>
                        <a href="#contact" class="btn1">Donate Here</a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="don-box">
                        ...
                        <h3>Fund</h3>
                        <p>Donate the Funds to the needy</p>
                        <a href="#contact" class="btn1">Donate Here</a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="don-box">
                        ...
                        <h3>Gadgets</h3>
                        <p>Donate the Gadgets to the needy</p>
                        <a href="#contact" class="btn1">Donate Here</a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="don-box">
                        ...
                        <h3>Stationary</h3>
                        <p>Donate the Staionary to the needy</p>
                        <a href="#contact" class="btn1">Donate Here</a>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="don-box">
                        ...
                        <h3>Food</h3>
                        <p>Donate the Food to the needy</p>
                        <a href="#contact" class="btn1">Donate Here</a>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 order-first order-lg-last">
                    ...
                    <p>We do the social works like donations,helping the needy peoples and give what they want.Giving is not about donation is about making difference.</p>
                    <p>This is not only the project it is an mission for the good changes in world.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="col-one">
                        <h4>Being Human</h4>
                        <p>Address : 3, Near Molacha Wada, Mahatma Gandhi Road, Satara 415205 </p>
                        <p>Contact No : <a href="tel: +91 9881670392">+91 9881670392</a></p>
                        <p>Email : <a href="Beinghuman@45.com">Beinghuman@45.com</a></p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="col-two">
